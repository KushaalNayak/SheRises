...
|------|---------------------|-------|-------------|------------|
| 1. | SheRises | Vite+React, JavaScript, Express.js, Node.js, MongoDB, JWT Authentication, Multer, bcryptjs, express-validator | [SheRises](https://github.com/kushaalnayak/SheRises) | Local Host / Vercel + Render |
